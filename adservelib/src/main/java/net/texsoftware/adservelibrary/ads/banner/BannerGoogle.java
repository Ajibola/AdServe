 ...
 */
public class BannerGoogle extends BannerAd {

    com.google.android.gms.ads.AdView mAdViewGoogle;
    com.google.android.gms.ads.AdRequest adRequestBanner;
    private final Activity activity;

    public BannerGoogle(Activity activity, BannerAdNetwork bannerAdNetwork) {
    ...
    public void initBanner() {
        mAdViewGoogle = new com.google.android.gms.ads.AdView(activity);
        mAdViewGoogle.setAdSize(com.google.android.gms.ads.AdSize.BANNER);
        ...
        adRequestBanner = new com.google.android.gms.ads.AdRequest.Builder()
                .setLocation(Util.geFastLocation(this.activity))
                .build();
